...
![](https://test.local/wp-content/uploads/2018/07/interactiveAgentCapability.png)
...
![](https://test.local/wp-content/uploads/2018/07/qaBuild.png)I also set it to trigger on any changes in my project (CI).  
![](https://test.local/wp-content/uploads/2018/07/trigger.png)
...
![](https://test.local/wp-content/uploads/2018/07/buildartifact.png)  
...
![](https://test.local/wp-content/uploads/2018/07/replaceTokens.png)
...
![](https://test.local/wp-content/uploads/2018/07/VSTestPlatformInstaller.png)
...
![](https://test.local/wp-content/uploads/2018/07/VSTestAssemblies.png)

Finally, set the definition demand so it points to the interactive agent.  
![](https://test.local/wp-content/uploads/2018/07/agentDemandInteractiveAgent.png)
