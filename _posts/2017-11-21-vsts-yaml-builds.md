...
```
<span class="pl-ent">phases</span>:
- <span class="pl-ent">phase</span>: <span class="pl-s">InitialPhase</span>
  <span class="pl-ent">steps</span>:
  - <span class="pl-ent">script</span>: <span class="pl-s">echo hello from initial phase</span>
- <span class="pl-ent">phase</span>: <span class="pl-s">SubsequentA</span>
  <span class="pl-ent">dependsOn</span>: <span class="pl-s">InitialPhase</span>
  <span class="pl-ent">steps</span>:
  - <span class="pl-ent">script</span>: <span class="pl-s">echo hello from subsequent A</span>
- <span class="pl-ent">phase</span>: <span class="pl-s">SubsequentB</span>
  <span class="pl-ent">dependsOn</span>: <span class="pl-s">InitialPhase</span>
  <span class="pl-ent">steps</span>:
  - <span class="pl-ent">script</span>: <span class="pl-s">echo hello from subsequent B</span>
```
