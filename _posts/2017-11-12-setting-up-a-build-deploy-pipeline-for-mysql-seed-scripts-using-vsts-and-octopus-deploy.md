...
![copy SQL Scripts](https://test.local/wp-content/uploads/2017/11/copySQLScripts.png)
...
![copy Shell Script](https://test.local/wp-content/uploads/2017/11/copyShellScript.png)
...
![package NuGet](https://test.local/wp-content/uploads/2017/11/packageNuGet.png)
...
![push NuGet Package To Octopus](https://test.local/wp-content/uploads/2017/11/pushNuGetPackageToOctopus.png)

**Create an Octopus release**

![Create Octopus Release](https://test.local/wp-content/uploads/2017/11/createOctopusRelease.png)
...
![Push NuGet Package To Server](https://test.local/wp-content/uploads/2017/11/pushNuGetPackageToServer.png)
...
![Execute Shell Script](https://test.local/wp-content/uploads/2017/11/ExecuteShellScript.png)
