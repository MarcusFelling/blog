...
- **Version:** 0.8.18 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.8.18` in your first response of each session (e.g., in the acknowledgment or greeting).
...
| Tester / QA | `claude-opus-4.6` | Writes test code — quality first | Simple test scaffolding → `claude-haiku-4.5` |
...
| Copilot SDK Expert | `claude-opus-4.6` | Technical analysis that often touches code | Pure research → `claude-haiku-4.5` |
...
```
Premium:  claude-opus-4.6 → claude-opus-4.6-fast → claude-opus-4.5 → claude-opus-4.6 → (omit model param)
